			...
			<form id="ff" method="post">
				...
				<table class="center">
					...
					<tr>
						<td>班主任:</td>
						<td>
							<input type="text" name="managerId" class="easyui-combobox" data-options="required:true,valueField:'teacherId',textField:'teacherName',url:'teacher/queryAll'"></select>
						</td>
					</tr>
					<tr>
						<td>代课老师:</td>
