...
$(function() {
	$("#dg").datagrid({
		...
		columns:[[  
	        ...
	        {field:'beginDate',title:'开设日期',width:100,align:'center'},
	        {field:'remark',title:'专业描述',width:150,align:'center'}
    	]],
		pagination: true,
		pageSize: 20,
		scrollbarSize: 0,
		...
		toolbar: [{
			...
			iconCls: 'icon-undo',
			handler: function() {
				location.href = "major/downloadAll";
			}
		}, '-', {
			text: "导出查询全部",
			iconCls: 'icon-undo',
			handler: function() {
				...
				location.href = "major/downloadPart?ids="+ids;
			}
		}, '-', {
			text: "导入",
			iconCls: 'icon-redo',
			...
			iconCls: 'icon-undo',
			handler: function() {
				location.href = "major/downloadMode?fileName=专业模板.xls";
			}
		}]
	});
