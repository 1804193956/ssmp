...
$(function() {
	$("#dg").datagrid({
		...
		columns:[[  
	        ...
	        {field:'studentStudyName',title:'专业',width:50,align:'center'},
		...
		toolbar: [{
			...
			iconCls: 'icon-undo',
			handler: function() {
				location.href = "studentStudy/downloadAll";
			}
		}, '-', {
			text: "导出查询全部",
			iconCls: 'icon-undo',
			handler: function() {
				location.href = "studentStudy/downloadPart";
			}
		}, '-', {
			text: "导入",
			iconCls: 'icon-redo',
			...
			iconCls: 'icon-undo',
			handler: function() {
				location.href = "studentStudy/downloadMode?fileName=正式学生模板.xls";
			}
		}]
	});
